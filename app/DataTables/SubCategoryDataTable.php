...
class SubCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            <a href="/admin/subcategory/' . $query->id . '/edit" ><i class="bx bx-edit mx-2"></i></a>
            <form action="/admin/subcategory/' . $query->id . '" method="post">
            ' . csrf_field() . '
            ' . method_field("DELETE") . '
    ...
    {
        return $model->newQuery()->with(['category'])->select('sub_categories.*');
    }
