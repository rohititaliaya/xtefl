                            ...
                            value: function () {
                                ...
                                o.options.keepImg ||
                                    ...
                                    "fixed" === o.image.position &&
                                        ...
                                        (o.image.position = n.length
                                            ? "absolute"
                                            : "fixed")),
                                    (a.position = o.image.position),
                                    o.css(o.image.$item, a),
                                    o.image.$container.appendChild(
                                        o.image.$item
                                    ),
                                    o.onResize(),
                                    o.onScroll(!0),
                                    o.options.onInit &&
                                        o.options.onInit.call(o),
                                    "none" !==
                                        o.css(o.$item, "background-image") &&
                                        o.css(o.$item, {
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                d.options.elementInViewport &&
                                    (y =
                                        d.options.elementInViewport.getBoundingClientRect()),
...
!(function (t, e) {
    ...
    function kb(t, e, r) {
        ...
        if (!c) {
            if (
                ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), xt[t])
            )
                c = xt[t];
            else if ("#" === t.charAt(0))
                4 === t.length &&
                ...
                if (((c = d = t.match(G)), e)) {
                    if (~t.indexOf("="))
                        return (
                            (c = t.match(J)), r && c.length < 4 && (c[3] = 1), c
                        );
                } else
                    (s = (+c[0] % 360) / 360),
                        (o = c[1] / 100),
    ...
    var Et,
        ...
        Rt =
            ...
            (Et.repeat = function repeat(t) {
                return arguments.length
                    ? ((this._repeat = t), Fa(this))
                    : this._repeat;
            }),
            (Et.repeatDelay = function repeatDelay(t) {
                return arguments.length
                    ? ((this._rDelay = t), Fa(this))
                    : this._rDelay;
            }),
    ...
    var Bt = (function (i) {
        function Timeline(t, e) {
            ...
            return (
                ...
                t.scrollTrigger &&
                    Aa(_assertThisInitialized(r), t.scrollTrigger),
                r
            );
        }
        ...
        return (
            (t.to = function to(t, e, r, i) {
                return (
                    new Ht(t, ca(arguments, 0, this), Ha(this, p(e) ? i : r)),
                    this
                );
            }),
            (t.from = function from(t, e, r, i) {
                return (
                    new Ht(t, ca(arguments, 1, this), Ha(this, p(e) ? i : r)),
                    this
                );
            }),
            (t.fromTo = function fromTo(t, e, r, i, n) {
                return (
                    new Ht(t, ca(arguments, 2, this), Ha(this, p(e) ? n : i)),
                    this
                );
            }),
            ...
            (t.previousLabel = function previousLabel(t) {
                return (
                    void 0 === t && (t = this._time), cb(this, Ha(this, t), 1)
                );
            }),
            ...
            (Timeline.updateRoot = function updateRoot(t) {
                if (
                    (F._ts && (ea(F, wa(t, F)), (d = Mt.frame)), Mt.frame >= ft)
                ) {
                    ft += U.autoSleep || 120;
                    var e = F._first;
                    if (
    ...
    function Lb(t, e, i, a, s, u) {
        ...
        if (
            ...
            ((i._pt = l =
                new ee(i._pt, s, t, 0, 1, h.render, h, 0, h.priority)),
            i !== c)
        )
            for (
            ...
            return (
                ...
                m !== Ve &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !Bd(hd(t, Le))),
                            ...
                            if (
                                ...
                                (d = (a + "").substr((u + "").length)) !==
                                    ...
                                    (this._pt = new ee(
                                        ...
                                        u,
                                        p ? p * o : o - u,
                                        "px" !== c || !1 === e.autoRound || _
                                            ? Tc
                                            : Wc
                                    )),
                                    (this._pt.u = c || 0),
                                    d !== c &&
                                        ((this._pt.b = a), (this._pt.r = Vc));
